package com.smartApi.controllers;
...
import com.smartApi.constant.Constant;
import com.smartApi.domain.Contact;
import com.smartApi.services.ContactService;
...
public class ContactController {
	...
	// return
	// ResponseEntity.created(URI.create("/contacts/userId")).body(contactService.saveContact(contact));
	// }
	@PostMapping
	public ResponseEntity<Contact> createContact(@RequestBody Contact contact) {
